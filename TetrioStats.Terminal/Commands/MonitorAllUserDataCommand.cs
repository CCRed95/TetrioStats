...
//					var response = await _client.FetchUserPersonalRecordsAsync(
//						userName, GameMode.TetraLeague, Leaderboard.Recent);

//					_timeCacheExpires = response.CacheInfo.CachedUntil;

//					var _40LinesResponse = await _client.FetchUserPersonalRecordsAsync(
//						response.Content.Username, GameMode.FortyLines, Leaderboard.Recent);
					
//					_time40LCacheExpires = _40LinesResponse.CacheInfo.CachedUntil;


//					var stats = response.Content;
//					var tl = stats.Records.First().Results.
