...
namespace TetrioStats.Api.Domain.Converters
{
    ...
    /// </summary>
    public class CustomUnixDateTimeConverter
        : DateTimeConverterBase
    {
      ...
      else if (value is DateTimeOffset dateTimeOffset)
      {
        ...
        /// The existing property value of the JSON that is being converted.</param>
        /// <param name="serializer">
        /// The calling serializer.
        /// </param>
        /// <returns>
        ...
        public override object? ReadJson(JsonReader reader,
            ...
            JsonSerializer serializer)
        {
            var nullable = objectType.IsGenericOf(typeof(Nullable<>));
